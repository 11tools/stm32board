 ...
 void LCD_GPIO_Config(void)
{
	 ...
	 */	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10 | GPIO_Pin_15;//PB1 ????,????
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_7|GPIO_Pin_8
																|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_14|GPIO_Pin_15;//PD0,1,4,5,8,9,10,14,15 AF OUT
  ...
  GPIO_PinAFConfig(GPIOD,GPIO_PinSource4,GPIO_AF_FSMC); //LCD_RD
  GPIO_PinAFConfig(GPIOD,GPIO_PinSource5,GPIO_AF_FSMC); //LCD_WR
  GPIO_PinAFConfig(GPIOD,GPIO_PinSource7,GPIO_AF_FSMC); //LCD_CS
  ...
  GPIO_PinAFConfig(GPIOE,GPIO_PinSource9,GPIO_AF_FSMC); //FSMC_D9
  ...
  GPIO_PinAFConfig(GPIOE,GPIO_PinSource15,GPIO_AF_FSMC);//FSMC_D12
		GPIO_SetBits(GPIOB, GPIO_Pin_15);		 // RST = 1 
...
{			
	Lcd_ColorBox(0,0,320,480,Color);
}
...
Gui_DrawPoint(10, 10, 0xaaaa);
printf("ReadPixel=%04x\r\n",ReadPixel(10, 10));
Gui_DrawPoint(10, 11, 0XFFFF);
printf("ReadPixel=%04x\r\n",ReadPixel(10, 11));
Gui_DrawPoint(10, 12, 0X00);
printf("ReadPixel=%04x\r\n",ReadPixel(10, 12));
}
/******************************************
函数名：Lcd写命令函数
...
u16 ReadPixel(u16 x,u8 y)
{
	...
	dat = *(__IO u16 *) (Bank1_LCD_D);
	printf("ReadPixel internal dat= %04x \r\n",dat);
